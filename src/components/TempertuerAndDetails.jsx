...
import { formatToLocalTime,iconUrlFronCode } from "../services/WeatherService";

function TempertuerAndDetails({
  weather:{
    details,
    icon,
    temp,
...
export default TempertuerAndDetails;